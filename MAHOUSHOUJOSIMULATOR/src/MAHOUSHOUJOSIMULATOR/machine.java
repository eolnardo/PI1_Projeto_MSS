...
public class machine {
		...
		while (vilao.vida > 0 && jogador.vida > 0 && menuc == false) {
			if (jogador.vida > 0) {
				...
				switch (luta) {
					case 1:
						...
						if (vilao.vida > 0) {
							System.out.println("\n[Kuriboh]:\n" + vilao.nome + " dispara uma bola de fogo que atinge "
									+ jogador.nome + ".");
			...
			if (jogador.vida <= 0) {
				System.out.println(
						"\n====================================================S2=========================================================\n");
				jogador.vida = 0;
				System.out.println("\n[Kuriboh]:\n" + vilao.nome + " avança até " + jogador.nome
						+ ", e coloca as duas mãos em seu rosto, num piscar de olhos, \no corpo inteiro do "
						+ jogador.nome + " está em chamas.");
				System.out.println("\n[Kuriboh]:\nVida de " + jogador.nome + ": ["
						+ (jogador.arredonda = (int) (jogador.vida + 0.5f)) + "]");
				morreuUmaVez++;
				menuc = true;
			}
			...
			if (vilao.vida <= 0) {
				System.out.println(
						"\n====================================================S2=========================================================\n");
				System.out.println("[Kuriboh]:\n" + jogador.nome + " olha para o " + vilao.nome
						+ " que agora está no chão. \nÉ possível ver que o ódio ainda queima em sua alma. "
						+ jogador.nome
						+ " desfere seu último golpe utilizando seu cetro mágico\no vilão explode espalhando pequenas faíscas pelo lugar.");
				System.out.println("\n[Kuriboh]:\nVida de " + vilao.nome + ": ["
						+ (vilao.arredonda = (int) (vilao.vida + 0.5f)) + "]");
				combate1 = true;
				magias.kuriboh += 4;
				menuc = true;
			}
		...
		while (vilao.vida > 0 && jogador.vida > 0 && menuc == false) {
			...
			if (jogador.vida <= 0) {
				System.out.println(
						"\n====================================================S2=========================================================\n");
				jogador.vida = 0;
				System.out.println("\n[Kuriboh]:\numa nuvem se forma em cima de " + jogador.nome
						+ ", e uma tempestade começa a cair sem parar, uma chuva ácida!\n" + jogador.nome
						+ " começa a derreter.");
				System.out.println("\n[Kuriboh]:\nVida de " + jogador.nome + ": ["
						+ (jogador.arredonda = (int) (jogador.vida + 0.5f)) + "]");
				morreuUmaVez++;
			...
			if (vilao.vida <= 0) {
				System.out.println(
						"\n====================================================S2=========================================================\n");
				System.out.println("[Kuriboh]:\n" + jogador.nome + " olha para o " + vilao.nome
						+ " que agora está no chão. \nA criatura está se contorcendo de dor. " + jogador.nome
		...
		while (vilao.vida > 0 && jogador.vida > 0 && menuc == false) {
			if (jogador.vida > 0) {
				...
				switch (luta) {
					case 1:
						...
						if (vilao.vida > 0) {
							System.out.println("\n[Kuriboh]:\n" + vilao.nome
									+ " dispara vários cristais de gelo na direção de " + jogador.nome + ".");
							vilao.ataque(jogador);
						}
						if (vilao.vida <= 0) {
							vilao.vida = 0;
			...
			if (jogador.vida <= 0) {
				System.out.println(
						"\n====================================================S2=========================================================\n");
				jogador.vida = 0;
				System.out.println("\n[Kuriboh]:\n" + vilao.nome + " ergue seus dois braços na direção de "
						+ jogador.nome
						+ ", o chão ao seu redor começa a tremer, \ne num piscar de olhos, um enorme domo se forma em volta de "
						+ jogador.nome + ", que fica preso em um vácuo.");
				System.out.println("\n[Kuriboh]:\nVida de " + jogador.nome + ": ["
						+ (jogador.arredonda = (int) (jogador.vida + 0.5f)) + "]");
				morreuUmaVez++;
				menuc = true;
	...
	void combatefinal(jogador jogador, viloes vilao) {
		...
		while (vilao.vida > 0 && jogador.vida > 0 && menuc == false) {
			if (jogador.vida > 0) {
				System.out.println(
						"\n[Kuriboh]:\n1. atacar!! (ataque) | 2. proteger! (defesa) | 3. CURINHA (vida+5) (cura) | 4. magia de luz (ataque) | 5. fuga (fugir)");
				try {
					luta = scan.nextInt();
				} catch (Exception e) {
					System.out.println("\nDigite um número!!");
				...
				switch (luta) {
					case 1:
						jogador.ataque(vilao);
						if (vilao.vida > 0) {
							System.out.println("\n[Kuriboh]:\n" + vilao.nome + " realiza uma rajada sônica na direção do " + jogador.nome + ".");
							vilao.ataque(jogador);
						}
						if (vilao.vida <= 0) {
							vilao.vida = 0;
					...
					case 3:
						...
						break;
					case 4:
						magias.magiadeluz(jogador, vilao);
						break;
					case 5:
						menuc = true;
						break;
			...
			if (jogador.vida <= 0) {
				System.out.println(
						"\n====================================================S2=========================================================\n");
				jogador.vida = 0;
				System.out.println("\n[Kuriboh]:\n"+ vilao.nome + " abre sua boca draconica, a energia ao redor do rosto da criatura começa a distorcer e \numa esfera energética começa a se formar. No segundo seguinte a esfera dispara na direção de " + jogador.nome + ", que \né atingido e decomposto.");
				System.out.println("\n[Kuriboh]:\nVida de " + jogador.nome + ": ["
						+ (jogador.arredonda = (int) (jogador.vida + 0.5f)) + "]");
				morreuUmaVez++;
				menuc = true;
	...
	void menucombate(viloes vilao1, viloes vilao2, viloes vilao3, jogador jogador) {
		while (menuc == false) {
			System.out.println(
					"\n====================================================S2=========================================================\n");
			System.out.print("\n[Kuriboh]:\n1. Haku, O senhor do Fogo" + " | 2. Kiara, a Rainha dos Oceanos"
	...
	void menucombate1(viloes vilao, viloes vilao2, viloes vilao3, jogador jogador) {
		while (menuc == false) {
			System.out.println(
					"\n====================================================S2=========================================================\n");
			System.out.print("\n[Kuriboh]:\n1. (eliminado) Haku, O senhor do Fogo | 2. Kiara, a Rainha dos Oceanos"
					+ " | 3. Kenku, o Mestre do Gelo" + ". | 4. MENU!\nComando aqui: ");
			menucombate = scan.nextInt();
			switch (menucombate) {
				case 1:
	...
	void menucombate2(viloes vilao, viloes vilao2, viloes vilao3, jogador jogador) {
		while (menuc == false) {
			System.out.println(
					"\n====================================================S2=========================================================\n");
			System.out.print(
					"\n[Kuriboh]:\n1. (eliminado) Haku, O senhor do Fogo | 2. (eliminado) Kiara, a Rainha dos Oceanos"
							+ " | 3. Kenku, o Mestre do Gelo" + ". | 4. MENU!\nComando aqui: ");
			menucombate = scan.nextInt();
			switch (menucombate) {
				case 1:
	...
	void menucombate3(viloes vilao, viloes vilao2, viloes vilao3, jogador jogador) {
		while (menuc == false) {
			System.out.println(
					"\n====================================================S2=========================================================\n");
			System.out.print("\n[Kuriboh]:\n1. Haku, O senhor do Fogo | 2. Kiara, a Rainha dos Oceanos"
					+ " | 3. (eliminado) Kenku, o Mestre do Gelo" + ". | 4. MENU!\nComando aqui: ");
			menucombate = scan.nextInt();
			switch (menucombate) {
				case 1:
	...
	void menusss(viloes vilao, viloes vilao1, viloes vilao2, jogador jogador, viloes vilaoespecial) {
		...
		if (combate1 == false && combate2 == false && combate3 == false) {
			...
			menuc = false;
			vilaoespecial.vidabase = 250;
			vilaoespecial.ataque = 60;
			vilaoespecial.defesa = 200;

			jogador.ataque = 50;
			jogador.defesa = 200;
			jogador.vidabase = 200;
			magias.kuriboh = 5;
			System.out.println(
